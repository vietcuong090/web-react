  ...
  return (
    <div className='flex py-6'>
      <div className='min-w-0 flex-1 lg:flex lg:flex-col'>
        <div className='lg:flex-1'>
          <div className='sm:flex'>
            ...
            duration-200 cursor-pointer inline-block mt-4 sm:mt-0'
            >
              <MdClose />
            </span>
          </div>
      ...
      <div
        ...
        className='ml-4 flex-shrink-0 h-20 w-20 sm:w-40 sm:h-40
      sm:order-first sm:m-0 sm:mr-6 border border-gray-200 rounded-md
      hover:border-skyText duration-200 cursor-pointer group overflow-hidden'
      >
        <img
