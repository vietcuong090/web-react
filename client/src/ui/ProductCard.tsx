  ...
  overflow-hidden hover:border-black duration-200 cursor-pointer'
    >
      <div className='w-full h-60 relative p-2 group'>
        <span
          onClick={open}
          className='bg-black text-skyText
        absolute left-0 right-0 w-16 text-xs text-center py-1 rounded-md font-semibold
        inline-block z-10'
        >
              ...
              >
                ...
                >
                  ...
                  <div className='mt-4'>
                    ...
                    gap-2 rounded-md bg-gray-700 py-1.5
                    px-3 text-sm/6 font-semibold text-white
                    shadow-inner shodow-white/10
                    focus:outline-none data-[hover]:bg-gray-60
                     data-[open]:bg-gray-700 data-[focus]:outline-1 \
