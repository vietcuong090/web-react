...
const CategoryFilters = ({ id }: { id: string | undefined }) => {
  ...
  return (
    <div className='hidden md:inline-flex flex-col gap-6'>
      ...
      <div>
        <p className='text-sm uppercase font-semibold underline decoration-[1px] mb-2 '>Select Categories</p>
          ...
          {loading ? (
            ...
            categories?.map((item: CategoryProps) => (
              <Link
                ...
                underline-offset-2 decoration-[1px] decoration-transparent
                hover:decoration-gray-950 hover:text-black duration-200 
