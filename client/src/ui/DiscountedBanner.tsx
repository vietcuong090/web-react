...
const DiscountedBanner = () => {
  const popularSearchItems = [
    ...
    { title: 'Laptop & Computers', link: 'comutersAndLaptop' },
    { title: 'Cell Phone', link: 'cellPhone' },
  ];
  return (
    <Container>
      <div>
      ...
      <div
        className='w-full py-5 md:py-0 my-12 bg-[#f6f6f6]
      rounded-lg flex items-center justify-between overflow-hidden'
      >
        <img src={discountImgOne} alt='discountImgOne' className='hidden lg:inline-flex h-36' />
        ...
        <img src={discountImgTwo} alt='discountImgTwo' className='hidden lg:inline-flex h-36' />
      </div>
      <div className='mt-7'>
